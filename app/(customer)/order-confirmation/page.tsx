        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-4xl mx-auto px-6 py-16 lg:py-24">
                ...
                <div className="text-center space-y-6 mb-16">
                    ...
                    <div>
                        <h1 className="text-4xl md:text-6xl font-medium text-black tracking-tighter">Order Captured.</h1>
                    ...
                    <div className="inline-flex items-center gap-3 bg-gray-50 border border-gray-100 px-6 py-3 rounded-2xl">
                        ...
                        <span className="font-medium text-black text-sm tracking-[0.2em]">{orderId}</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-6">
                        <div className="bg-white rounded-[2rem] border border-gray-100 overflow-hidden  ">
                            ...
                            <div className="divide-y divide-gray-50">
                                <div className="px-8 py-6 flex items-start gap-5">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-gray-400 font-medium uppercase tracking-wider mb-1">Pick up on</p>
                                        <p className="font-medium text-lg text-black tracking-tight">{displayDate}</p>
                                        <p className="font-medium text-[#D60000] text-sm mt-0.5 uppercase tracking-widest">{slot}</p>
                                    </div>
                                </div>
                                <div className="px-8 py-6 flex items-start gap-5">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-gray-400 font-medium uppercase tracking-wider mb-1">Pick up at</p>
                                        <p className="font-medium text-base text-black tracking-tight">{STORE_ADDRESS}</p>
                                        <p className="text-gray-400 text-xs font-medium uppercase tracking-widest mt-1">Standard Store Hours: 8 AM - 10 PM</p>
                                    </div>
                                </div>
                                <div className="px-8 py-6 flex items-start gap-5">
                                    <div className="w-10 h-10 bg-gray-100 text-black rounded-xl flex items-center justify-center flex-shrink-0 mt-1">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-gray-400 font-medium uppercase tracking-wider mb-1">Payment Method</p>
                                        <p className="font-medium text-base text-black tracking-tight">
                                            {payment === "pay-online" ? "Digital Transaction" : "Pay at Counter"}
                                        </p>
                                        <p className="font-medium text-black text-sm mt-0.5">₹{total} Total</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    {orderData.order_items.map((item: any) => (
                                        <div key={item.id} className="px-8 py-4 flex items-center justify-between">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="font-medium text-sm text-black tracking-tight">{item.products?.name || "Product"}</p>
                                                    <p className="text-[10px] text-gray-400 font-medium uppercase tracking-wider mt-0.5">Qty: {item.quantity}</p>
                                                </div>
                                            </div>
                                            <p className="font-medium text-sm text-black">₹{(Number(item.price) * item.quantity).toFixed(0)}</p>
                                        </div>
                                    ))}
                                </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <Link
                                href="#"
                                className="flex-1 flex items-center justify-center gap-3 border border-gray-200 text-black font-medium py-5 rounded-2xl hover:border-black active:scale-[0.98] transition-all uppercase tracking-widest text-[11px]"
                            >
                                Orders
                            </Link>
                        </div>
                    ...
                    <div className="bg-[#0A0A0A] text-white rounded-[2rem] p-10 relative overflow-hidden  ">
                        ...
                        />
                        <h2 className="text-[10px] font-medium text-gray-500 uppercase tracking-[0.2em] mb-10 flex items-center gap-3">
                        ...
                        <div className="mt-12 pt-10 border-t border-white/[0.05]">
                            <p className="text-[10px] text-gray-600 font-medium uppercase tracking-[0.15em] text-center italic">
        ...
        <Suspense fallback={
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center space-y-3">
                    ...
                    <p className="font-medium text-gray-400">Loading your order…</p>
                </div>
            </div>
        }>
