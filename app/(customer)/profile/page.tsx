                    ...
                    <div className="lg:w-1/3 space-y-8">
                        <div className="bg-gray-50 rounded-[2.5rem] p-10 border border-gray-100 relative overflow-hidden group">
                            <div className="relative z-10 flex flex-col items-center text-center">
                                <div className="w-24 h-24 bg-black rounded-[2rem] flex items-center justify-center text-white text-3xl font-medium mb-6 group-hover:scale-105 transition-transform duration-500">
                                    {displayName.substring(0, 1).toUpperCase()}
                                </div>
                                <h1 className="text-2xl font-medium text-black mb-1">{displayName}</h1>
                                <p className="text-sm text-gray-400 font-medium italic mb-6">{user?.phone}</p>
                                
                                <div className="inline-flex px-4 py-1.5 bg-green-50 text-green-600 rounded-full text-[10px] font-medium uppercase tracking-widest border border-green-100">
                                    Verified Account
                                </div>
                            </div>
                        ...
                        <nav className="space-y-2">
                            <Link href="/orders" className="flex items-center justify-between p-5 bg-white border border-gray-100 rounded-2xl hover:bg-gray-50 transition-colors group">
                                <div className="flex items-center gap-4 text-gray-600 group-hover:text-black transition-colors font-medium text-sm tracking-tight">
                            ...
                            >
                                <div className="flex items-center gap-4 text-red-600 transition-colors font-medium text-sm tracking-tight">
                    ...
                    <div className="flex-1 space-y-10">
                        <div className="bg-white p-10 rounded-[3rem] border border-gray-100  space-y-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-4">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input 
                                            ...
                                            readOnly 
                                            value={displayName}
                                            className="w-full bg-gray-50 border border-gray-100 rounded-2xl py-4 pl-14 pr-6 text-sm font-medium text-black outline-none focus:bg-white focus:border-black transition-all"
                                        />
                                    </div>
                                </div>

                                <div className="space-y-4">
                                    <label className="text-[10px] font-medium text-gray-400 uppercase tracking-widest ml-1">Phone Number</label>
                                    <div className="relative group">
                                ...
                                <div className="space-y-4 md:col-span-2">
                                    <label className="text-[10px] font-medium text-gray-400 uppercase tracking-widest ml-1">Account Role</label>
                                    <div className="relative group">
                        ...
                        <div className="bg-black rounded-[3rem] p-12 text-white relative overflow-hidden group  ">
                            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                                ...
                                <Link href="/orders" className="px-8 py-4 bg-[#D60000] text-white font-medium rounded-2xl hover:bg-white hover:text-black transition-all text-xs uppercase tracking-widest">
                                    View Order History
                                </Link>
                            </div>
