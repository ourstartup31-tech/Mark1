...
export default function StoreSettingsPage() {
    ...
    return (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div>
                <h1 className="text-4xl font-medium text-black tracking-tight">Store Settings</h1>
                ...
                <div className="xl:col-span-2 space-y-8">
                    <form onSubmit={handleUpdateInfo} className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-8">
                        <div className="flex items-center gap-4 mb-2">
                            ...
                            <h2 className="text-2xl font-medium text-black tracking-tight">General Information</h2>
                        </div>
                    ...
                    <section className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-8">
                        <div className="flex items-center gap-4 mb-2">
                            ...
                            <h2 className="text-2xl font-medium text-black tracking-tight">Opening Hours</h2>
                        </div>
                        <StoreTimingForm />
                    </section>
                </div>
                ...
                <div className="space-y-8">
                    <section className="bg-black rounded-[2.5rem] p-10 text-white space-y-8">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-xl font-medium tracking-tight">Special Closures</h2>
                            </div>
                        ...
                        <div className="space-y-4">
                                ...
                                return (
                                    <div key={idx} className="flex items-center justify-between p-5 bg-white/5 rounded-2xl border border-white/5 group hover:bg-white/10 transition-colors">
                                        <div>
                                            ...
                                            <p className="text-[10px] text-gray-500 font-medium uppercase tracking-wider mt-0.5">{reason}</p>
                                        </div>
                            ...
                            {storeSettings.closedDates.length === 0 && (
                                <div className="py-10 text-center border-2 border-dashed border-white/5 rounded-2xl">
                                    <p className="text-xs text-gray-500 font-medium uppercase tracking-widest">No closures scheduled</p>
                                </div>
                            )}
                        </div>

                        <div className="pt-4">
                            <Button onClick={() => setIsHolidayModalOpen(true)} className="w-full py-6 rounded-2xl bg-white text-black hover:bg-gray-200 transition-all font-medium">
                                Add New Closure
                            </Button>
                        </div>
                    </section>
                    ...
                    <Modal isOpen={isHolidayModalOpen} onClose={() => setIsHolidayModalOpen(false)} title="Add Closure">
                        <form onSubmit={handleAddHoliday} className="space-y-6">
                            ...
                            <Button type="submit" className="w-full py-6 rounded-2xl bg-[#D60000] text-white hover:bg-black transition-all font-medium">
                                Save Closure
                            </Button>
                        </form>
                    </Modal>
                    ...
                    <div className="p-8 bg-[#D60000]/5 rounded-[2rem] border border-[#D60000]/10 border-dashed">
                        <p className="text-[10px] font-medium text-[#D60000] uppercase tracking-[0.2em] mb-2 text-center">Important Note</p>
